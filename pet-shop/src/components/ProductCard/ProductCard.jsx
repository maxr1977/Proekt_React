        ...
        <div className={styles.product_card_wrapper}>
            <Link to={`/products/${id}`} className={styles.product_card}>
                <div className={styles.image_wrapper}>
                    <img src={`${import.meta.env.VITE_API_BASE_URL}${image}`} alt={title} />
                </div>
            ...
            <div className={styles.add_to_cart_btn_wrapper}>
                {isAdded ? (
                    <UIButton theme='added' disabled>Added</UIButton>
                ) : (
                    <UIButton theme='primary' onClick={handleAddToCart}>Add to cart</UIButton>
                )}
            </div>
        </div>
    );
